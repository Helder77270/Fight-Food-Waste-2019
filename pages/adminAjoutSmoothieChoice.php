        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <?php
                    $info_product = DatabaseManager::getSharedInstance()->selec("SELECT * FROM smoothie WHERE id=?", [$id]);

                        echo "<div class='col-12'><h5 style='margin-top: 30px'>".$info_product[0]['title']."</h5></div>";
                        echo "<div class='col-3'><img style='height: 80px' src='../images/smoothie/" . $info_product[0]['image'] .".jpg'></div>";
                        echo "<div class='col-3'>" . $info_product[0]['sub_title'] . "</div>";
                        echo "<div class='col-3'>" . $info_product[0]['description'] . "</div>";
                        echo "<div class='col-3'>" . $info_product[0]['description2'] . "</div>";
                    ...
                    <div class="row" style="color: #2c9faf">
                        <div class="col-8" style="text-align: center">
                            <a href="../services/admin/adminChangeStatusSmoothie.php?id=<?php echo $id;?>&status=<?php echo $stNb;?>">
                        <?php
                        echo $state;
                        ?>
                            </a>
                    ...
                    <div class="col-4" style="text-align: center">
                        <a href="adminAjoutSmoothie.php">Annuler</a>
                    </div>
                    </div>
                </div>
