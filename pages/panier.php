            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    foreach ($info as $key){
                        ...
                        echo "<div style='background-color: lightgrey; text-align: center; padding: 20px; margin-bottom: 20px' class='col-12'>";
                        echo "<h5><i>".$key['num_order']."</i></h5>";


                        $info2 = DatabaseManager::getSharedInstance()->selec("SELECT * FROM product WHERE fk_num_order=?", [$key['num_order']] );

                        foreach ($info2 as $key2){
                            echo $key2['name']."<br>";
                        }
                        echo "</div>";
