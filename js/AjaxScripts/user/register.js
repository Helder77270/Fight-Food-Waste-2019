$(document).ready(function () {
    ...
    var form = $('#registerform'); // sélectionne le formulaire
    ...
    registerbutton.click(function (e) {
        ...
        $.ajax({
            ...
            url: '../services/user/create.php', //Appelle le script PHP à exécuter, chemin à écrire comme si on cherchait de fichier de par la page sur laquelle il est intégrer
            ...
            error: function (response) {
                ...
                if (response.error) {
                    ...
                    resultDiv.append("<div class='alert alert-success' role='alert'>"+ response.success +"</div>");
