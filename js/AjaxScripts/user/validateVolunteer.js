$(document).ready(function () {
    ...
    var form = $('#validateForm'); // sélectionne le formulaire
    var validation_button = $('#validation_button');
    ...
    validation_button.click(function (e) { //
        ...
        $.ajax({
            ...
            url: '../../services/user/validate.php', //Appelle le script PHP à exécuter, chemin à écrire comme si on cherchait de fichier de par la page sur laquelle il est intégrer
