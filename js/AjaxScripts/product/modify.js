$(document).ready(function () {
    ...
    var form = $('#productModification'); // sélectionne le formulaire
    ...
    updateprod.click(function (e) { //
        ...
        $.ajax({
            ...
            url: '../services/products/updateFromAdmin.php', //Appelle le script PHP à exécuter, chemin à écrire comme si on cherchait de fichier de par la page sur laquelle il est intégrer
